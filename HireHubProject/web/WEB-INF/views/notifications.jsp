...
<head>
    ...
    <style>
        ...
        .notif-title { font-weight: 700; color: var(--text-primary); margin-bottom: 4px; font-size: 0.95rem; }
        .notif-msg { color: var(--text-secondary); font-size: 0.875rem; line-height: 1.5; }
        .notif-time { font-size: 0.78rem; color: var(--text-muted); margin-top: 6px; }
    </style>
</head>
<body class="app-page">
