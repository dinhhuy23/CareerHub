    ...
    <div class="form-card">
        ...
        <form action="<%= actionUrl %>" method="post">
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="logoUrl" class="form-control"
                           value="<%= company != null && company.getLogoUrl() != null ? company.getLogoUrl() : "" %>">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <textarea name="description" class="form-textarea" rows="6"><%= company != null && company.getDescription() != null ? company.getDescription() : "" %></textarea>
            </div>
