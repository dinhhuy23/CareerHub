...
public class ApplicationDAO {
    ...
    private Application mapResultSetToApplication(ResultSet rs) throws SQLException {
        ...
        try {
            app.setCandidateId(rs.getLong("CandidateUserId"));
        } catch (Exception e) {
        }
        ...
        try {
            app.setUpdatedAt(rs.getTimestamp("LastStatusChangedAt"));
        } catch (Exception e) {
        }
        try {
            app.setHrNote(rs.getString("RecruiterNote"));
        } catch (Exception e) {
        }
        ...
        try {
            app.setCandidateName(rs.getString("FullName"));
        } catch (Exception e) {
        }
        try {
        ...
        try {
            app.setCandidateAvatar(rs.getString("AvatarUrl"));
        } catch (Exception e) {
        }
        try {
